...
> 참조: .claude/docs/team-operations.md (AW-001: 모델 선택, AW-002: 3-agent 조사)
...
**상황 2**: 보안 관련 변경 → `security-reviewer sonnet` (내부망 opus 불가, AW-001)
...
- [.claude/docs/team-operations.md](./team-operations.md) — AW-001: 모델 선택, AW-002: 3-agent 조사
